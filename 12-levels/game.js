var sprites = {
    ...
    enemy_little: {sx: 0, sy: 42, w: 12, h: 21, frames: 1},
    enemy_purple: { sx: 37, sy: 0, w: 42, h: 43, frames: 1 },
    enemy_bee: { sx: 79, sy: 0, w: 37, h: 43, frames: 1 },
    enemy_ship: { sx: 116, sy: 0, w: 42, h: 43, frames: 1 },
    enemy_circle: { sx: 158, sy: 0, w: 32, h: 33, frames: 1 },
    enemy_boss: {sx: 97, sy: 0, w : 82, h: 43, frames: 1},
    explosion: { sx: 0, sy: 64, w: 64, h: 64, frames: 12 }
};

var enemies = {

	 little: { x: 0,   y: -50, sprite: 'enemy_little', health: 10, 
		E: 100},
...
var PlayerFireN = function(x,y) {
    ...
    this.setup('explosion',{ vy: -1500, vx: -150, damage: 10 });
    this.x = x - this.w/2; 
    this.y = y - this.h; 
};

PlayerFireN.prototype = new Sprite();
PlayerFireN.prototype.type = OBJECT_PLAYER_FIREBALL;
...
PlayerFireB.prototype.type = OBJECT_PLAYER_FIREBALL;
